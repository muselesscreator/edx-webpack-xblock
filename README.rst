README for edx-webpack-xblock

Simple Webpack Xblock Example
=============================

The purpose of this package is to serve as a simple template and proof-of-concept for wrapping xblock code in ES6/react.
...
``edx-webpack-xblock/edx-webpack-xblock/locale/en/LC_MESSAGES/text.po``.
