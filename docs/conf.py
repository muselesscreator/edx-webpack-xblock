...
"""
edx-webpack-xblock documentation build configuration file.
...
VERSION = get_version('../edx-webpack-xblock', '__init__.py')
...
project = 'edx-webpack-xblock'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx-webpack-xblock'
...
#
# html_title = 'edx-webpack-xblock v0.0.1'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'edx-webpack-xblock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx-webpack-xblock'),
                os.path.join(root_path, 'edx-webpack-xblock/migrations')])
